...
import { BookOpen, Star, Lightbulb, Lock } from "lucide-react";
    ...
    <div className="min-h-screen gradient-primary">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center text-white">
        ...
        <Button
          ...
          size="lg"
          className="bg-white hover:bg-white/90 text-primary text-lg font-bold px-12 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 animate-bounce-in"
